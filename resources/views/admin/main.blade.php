        ...
        <div class="card-group">
            ...
            <div class="card border-right border-success">
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">{{ $eventCount }}</h2>
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Post Event
                            </h6>
                        </div>
                        <div class="ml-auto mt-md-3 mt-lg-0">
                            <span class="opacity-7 text-muted"><i data-feather="check-circle"></i></span>
            ...
            <div class="card border-right border-secondary">
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">{{ $publicCount }}</h2>
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Post Public
                            </h6>
                        </div>
                        <div class="ml-auto mt-md-3 mt-lg-0">
                            <span class="opacity-7 text-muted"><i data-feather="check-circle"></i></span>
